...
def add_building(request):
    if request.method == 'POST':
        num_batiment = request.POST.get('num_batiment')
        nom_batiment = request.POST.get('nom_batiment')
        
        Batiment.objects.create(num_batiment=num_batiment, nom_batiment=nom_batiment)
...
def add_classroom_save(request):
    if request.method != "POST":
        ...
        batiment_id = request.POST.get("id_batiment")
